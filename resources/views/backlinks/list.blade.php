                                        ...
                                        <td>
                                            @if ($backlink->status == 'Active')
                                                <span class="badge bg-success" data-toggle="tooltip"
                                                    title="{{ $backlink->notes_comments }}">{{ ucfirst($backlink->status) }}</span>
                                            @elseif ($backlink->status == 'Pending')
                                                <span class="badge bg-warning" data-toggle="tooltip"
                                                    title="{{ $backlink->notes_comments }}">{{ ucfirst($backlink->status) }}</span>
                                            @elseif ($backlink->status == 'Declined')
                                                <span class="badge bg-danger" data-toggle="tooltip"
                                                    title="{{ $backlink->notes_comments ?? 'Reason not provided' }}">Rejected</span>
                                            @else
